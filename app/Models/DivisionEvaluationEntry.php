...
class DivisionEvaluationEntry extends Model
{
    use HasFactory;

    protected $table = 'division_evaluation_entries';
    protected $primaryKey = 'id';
    protected $fillable = ["division_evaluation_id","key_perf_area","kpi_template_id","weight","target","actual","score"];
